...
<body>
    ...
    <div class="navbar-top">
        <div class="container">
            <nav class="nav justify-content-end">
                ...
                <a class="nav-link" href="https://www.instagram.com/indienews157" target="__blank" ><i class="fab fa-instagram"></i></a>
    ...
    <div class="pagina-radio" style="margin-top: -4rem;">
        <iframe src="//www.zeno.fm/player/indie-157-radio" width="100%" height="520px" frameborder="0" scrolling="no" data-autoplay="true">
        </iframe>
    </div>
